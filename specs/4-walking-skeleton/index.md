...
| ADR-0028 (新規)                  | 注釈画像を SVG とし生スクリーンショットを別ファイルで参照する判断              | 新規起票 (D11 を正本化)                                                                       |
...
| ADR (新規) | 注釈画像を SVG とし、生スクリーンショットを別ファイルで持って参照する判断を新規 ADR として起こす (source: clarify) **反映済 (81f4f81)**                                                                                                                                                                                                        | 選択肢を比較した判断であり、Design Doc の成功条件を変えるため (D11)                                                                                                                                                                                                   |
